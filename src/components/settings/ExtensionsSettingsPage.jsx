...
const ExtensionsSettingsPage = ({ onOpenExtensions }) => (
  <SectionShell icon={MdViewInAr} title="Extensions" description="Ajoutez des outils à BlueFox depuis le catalogue officiel." className="bluefox-settings-extensions-section">
    ...
    <button type="button" className="bluefox-settings-primary-button bluefox-settings-extensions-button" onClick={onOpenExtensions}>Ouvrir BlueFox Add-ons</button>
